                ...
                switch lower(markerProperties.trackType)
                    ...
                    case 'auto'
                        ...
                        [markerPos, atEdge, multipleBlobs, markerArea, markerAspectRatio]=...
                            ...
                            max([1, round(startPos(2)-startBoxSize(2)-searchRadius)]):...
                            min([frameSize(1), round(startPos(2)+startBoxSize(2)+searchRadius)]),...
                            max([1, round(startPos(1)-startBoxSize(1)-searchRadius)]):...
                            min([frameSize(2), round(startPos(1)+startBoxSize(1)+searchRadius)]), :),...
